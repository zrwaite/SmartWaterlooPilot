...
const handleCheckboxChange = (event: React.ChangeEvent<HTMLInputElement>, state: any, setState: (state:any) => void) => {
...
const handleInputChange = (event: React.ChangeEvent<HTMLInputElement>, state: any, setState: (state: any) => void) => {
