	...
	return (
		<>
			<div className={"nicknameContainer"}>
				...
				<button style={spacing} onClick={canSubmit?trySubmit:undefined} className={`${canSubmit?"blackButton":"disabledButton"} signUpButton`}>Start using the Data Playground.</button>
			</div>
