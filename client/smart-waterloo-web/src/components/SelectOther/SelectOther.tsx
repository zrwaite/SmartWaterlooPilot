...
const SelectOther = (props: SelectOtherProps) => {
	return (<>
		...
		{props.data.select==="Other"&&<input name={props.name} placeholder={"Please specify your response"} value={props.data.text} onChange={props.handleParentSelectTextChange} />}
	</>);
}
